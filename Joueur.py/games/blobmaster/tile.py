...
class Tile(GameObject):
    """The class representing the Tile in the Blobmaster game.
    ...
    def __init__(self):
        ...
        self._blob = None
        self._drop_owner = None
        self._drop_turns_left = 0
        self._slime = 0
    ...
    @property
    def blob(self):
        """The Blob that is on this Tile, None otherwise.
    ...
    @property
    def drop_owner(self):
        """The owner of the blob dropping onto this tile, or None.

        :rtype: games.blobmaster.player.Player
        """
        return self._drop_owner

    @property
    def drop_turns_left(self):
        """Turns until a blob is dropped onto this tile. negative if no blob is in transit to this tile.

        :rtype: int
        """
        return self._drop_turns_left
    ...
    def has_neighbor(self, tile):
        ...
        Args:
            tile (games.blobmaster.tile.Tile): tile to check against
        Returns:
